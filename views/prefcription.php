...
<div class="text-center"><div class="text-center"><?php //echo $this->session->flashdata('msg'); ?></div></div>
        ...
        <div  class="row">
            ...
            <table class="table table-bordered table-responsive">
                 ...
                 <div></div>
                    <tr><td><b>Date:</b></td><td><b><?php echo date('d-m-Y');?></b></td>
                       <td><b>PT-ID</b></td> <td><b><?php echo $result['id'];?></b></td>
                  </tr>

                    <tr>
                     <td><b>Name</b></td> <td><b><?php echo $result['first'];?> <?php echo $result['last'];?></b> </td>
                      <td><b>Contact</b></td> <td><b><?php echo $result['contact'];?></b></td>
                    </tr>
                   

                    </tr>
                    
                     <tr><td><b>Address</b></td> <td><b><?php echo $result['address'].",".$result['city'];?></b></td>
                        <td><b>Age</td> </b><td><b><?php echo $result['age'];?></b></td>
                     </tr>
                     <tr>
                       <td><b>Cheif Complaint</b></td> <td><b><?php echo $result['purpose'];?></b></td>
